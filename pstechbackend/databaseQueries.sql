...
INSERT INTO `pstech`.`product` (`code`, `name`, `brand`, `description`, `unit_price`, `quantity`, `is_active`, `category_id`, `supplier_id`, `purchases`, `views`) VALUES ('PRDABC123DEFX', 'HP ENVY x360 13-ag0035au', 'HP', 'Windows 10 MobileMark 14 Battery life will vary depending on various factors including product model, configuration, loaded applications, features, use, wireless functionality, and power management settings.', '81794', '5', '1', '1', '2', '0', '0');
