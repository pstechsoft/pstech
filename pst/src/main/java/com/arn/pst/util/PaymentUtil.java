...
public class PaymentUtil {
    ...
    private static final String paymentKey = "P17f9Vcg";

    private static final String paymentSalt = "GaDTp7GY7k";

    private static final String sUrl = "http://localhost:9090/payment/payment-response";

    private static final String fUrl = "http://localhost:9090/payment/payment-response";
