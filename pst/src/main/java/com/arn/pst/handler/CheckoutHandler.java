...
public class CheckoutHandler {
	...
	/*
	 * public String deleteAddress(CheckoutModel checkoutModel, Address shipping) {
	 * 
	 * String transitionValue = "success"; userDAO.deleteAddress(shipping);
	 * 
	 * checkoutModel.setShipping(shipping);
	 * 
	 * return transitionValue;
	...
	public String saveOrder(CheckoutModel checkoutModel) {
		...
		cart.setGrandTotal((int) (cart.getGrandTotal() - orderTotal));
